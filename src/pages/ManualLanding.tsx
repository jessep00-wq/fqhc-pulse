              ...
              {[
                ...
                <div key={f.key} className="mb-3">
                  ...
                  <input
                    ...
                    required
                    className="w-full bg-white/5 border border-white/10 rounded-lg px-3.5 py-2.5 text-sm text-white outline-none focus:border-[#1A7A7A] placeholder:text-white/25 transition-colors"
                  />
                </div>
              ))}
