...
export default function CycleEvidenceDocDialog({
  ...
  const cycleUpdatedAt =
    (cycle as { updated_at?: string | null }).updated_at ||
    revisions.reduce<string | null>((a, r) => (!a || r.created_at > a ? r.created_at : a), null) ||
    cycle.created_at;
            ...
            <div ref={printRef} style={{ background: "#fff" }}>
              ...
              <div style={{ width: "800px", minHeight: "1050px", background: "#1a2e3b", color: "#fff", display: "flex", flexDirection: "column" }}>
                ...
                <div style={{ flex: 1, padding: "0 48px", display: "flex", flexDirection: "column", justifyContent: "center" }}>
                  ...
                  <p style={{ fontSize: "13px", marginTop: "4px" }}><span style={{ color: "#5eead4", fontWeight: 600 }}>Cycle Last Updated:</span> {fmtDateTime(cycleUpdatedAt)}</p>
                ...
                <div style={{ padding: "24px 48px", textAlign: "center" }}>
                  <p style={{ fontSize: "11px", color: "#64748b", fontStyle: "italic" }}>
                    Document generated: {generatedOn} · Cycle last updated: {fmtDate(cycleUpdatedAt)} · Version {version}
                  </p>
                </div>
              </div>
