...
//   - the server-side audit function (supabase/functions/run-evidence-audit)
//   - the browser (via src/lib/ai/evidenceRules.ts, which re-exports this file)
//
// Everything decidable from stored records is decided HERE, in code.
// The language model is never asked whether a field, date, owner, task,
// result, or evidence item exists.
// =============================================================================
